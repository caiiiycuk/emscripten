...
Кроме того вы можете :ref:`Сообщить о ошибках <bug-reports>` в инструментарии или на сайте. Раздел :ref:`emscripten-test-suite` идеально подходит для поиска примеров использования Emscripten.
